...
public abstract class FacebookButtonBase extends Button {
    ...
    protected FacebookButtonBase(
        ...
        defStyleRes = (defStyleRes == 0 ? FacebookExtension.context.getResourceId("style.com_facebook_button") : defStyleRes);
    ...
    private void parseBackgroundAttributes(
        ...
        try {
            if (a.hasValue(0)) {
                ...
                setBackgroundColor(a.getColor(0, FacebookExtension.context.getResourceId("color.com_facebook_blue")));
            }
        } finally {
            a.recycle();
        }
