...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final View view = inflater.inflate(FacebookExtension.context.getResourceId("layout.com_facebook_login_fragment"), container, false);
        ...
        loginClient.setBackgroundProcessingListener(
            ...
            public void onBackgroundProcessingStarted() {
                view.findViewById(
                		FacebookExtension.context.getResourceId("id.com_facebook_login_activity_progress_bar")).setVisibility(View.VISIBLE);
            }

            @Override
            public void onBackgroundProcessingStopped() {
                view.findViewById(
                		FacebookExtension.context.getResourceId("id.com_facebook_login_activity_progress_bar")).setVisibility(View.GONE);
            }
        });
    ...
    public void onPause() {
        ...
        getActivity().findViewById(FacebookExtension.context.getResourceId("id.com_facebook_login_activity_progress_bar")).setVisibility(
                View.GONE);
    }
