...
public class ProfilePictureView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(
                attrs, new int[] {
                		FacebookExtension.context.getResourceId("attr.com_facebook_preset_size"),
                		FacebookExtension.context.getResourceId("attr.com_facebook_is_cropped")
        });
        setPresetSize(a.getInt(FacebookExtension.context.getResourceId("styleable.com_facebook_profile_picture_view_com_facebook_preset_size"), CUSTOM));
        isCropped = a.getBoolean(
        		FacebookExtension.context.getResourceId("styleable.com_facebook_profile_picture_view_com_facebook_is_cropped"), IS_CROPPED_DEFAULT_VALUE);
        a.recycle();
    }
    ...
    private void setBlankProfilePicture() {
        ...
        if (customizedDefaultProfilePicture == null) {
            int blankImageResource = isCropped() ?
            		FacebookExtension.context.getResourceId("drawable.com_facebook_profile_picture_blank_square") :
            			FacebookExtension.context.getResourceId("drawable.com_facebook_profile_picture_blank_portrait");
    ...
    private int getPresetSizeInPixels(boolean forcePreset) {
        ...
        switch (presetSizeType) {
            case SMALL:
                dimensionId = FacebookExtension.context.getResourceId("dimen.com_facebook_profilepictureview_preset_size_small");
                break;
            case NORMAL:
                dimensionId = FacebookExtension.context.getResourceId("dimen.com_facebook_profilepictureview_preset_size_normal");
                break;
            case LARGE:
                dimensionId = FacebookExtension.context.getResourceId("dimen.com_facebook_profilepictureview_preset_size_large");
                break;
            case CUSTOM:
                if (!forcePreset) {
