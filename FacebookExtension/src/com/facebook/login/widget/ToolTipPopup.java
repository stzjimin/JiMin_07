...
public class ToolTipPopup {
    ...
    public void show() {
        if (mAnchorViewRef.get() != null) {
            ...
            TextView body = (TextView) mPopupContent.findViewById(
            		FacebookExtension.context.getResourceId("id.com_facebook_tooltip_bubble_view_text_body"));
            body.setText(mText);
            if (mStyle == Style.BLUE) {
                mPopupContent.bodyFrame.setBackgroundResource(
                		FacebookExtension.context.getResourceId("drawable.com_facebook_tooltip_blue_background"));
                mPopupContent.bottomArrow.setImageResource(
                		FacebookExtension.context.getResourceId("drawable.com_facebook_tooltip_blue_bottomnub"));
                mPopupContent.topArrow.setImageResource(
                		FacebookExtension.context.getResourceId("drawable.com_facebook_tooltip_blue_topnub"));
                mPopupContent.xOut.setImageResource(FacebookExtension.context.getResourceId("drawable.com_facebook_tooltip_blue_xout"));
            } else {
                mPopupContent.bodyFrame.setBackgroundResource(
                		FacebookExtension.context.getResourceId("drawable.com_facebook_tooltip_black_background"));
                mPopupContent.bottomArrow.setImageResource(
                		FacebookExtension.context.getResourceId("drawable.com_facebook_tooltip_black_bottomnub"));
                mPopupContent.topArrow.setImageResource(
                		FacebookExtension.context.getResourceId("drawable.com_facebook_tooltip_black_topnub"));
                mPopupContent.xOut.setImageResource(FacebookExtension.context.getResourceId("drawable.com_facebook_tooltip_black_xout"));
            }
    ...
    private class PopupContentView extends FrameLayout {
        ...
        private void init() {
            ...
            inflater.inflate(FacebookExtension.context.getResourceId("layout.com_facebook_tooltip_bubble"), this);
            topArrow = (ImageView) findViewById(FacebookExtension.context.getResourceId("id.com_facebook_tooltip_bubble_view_top_pointer"));
            bottomArrow = (ImageView) findViewById(
            		FacebookExtension.context.getResourceId("id.com_facebook_tooltip_bubble_view_bottom_pointer"));
            bodyFrame = findViewById(FacebookExtension.context.getResourceId("id.com_facebook_body_frame"));
            xOut = (ImageView) findViewById(FacebookExtension.context.getResourceId("id.com_facebook_button_xout"));
        }
