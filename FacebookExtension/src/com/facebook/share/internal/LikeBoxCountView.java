...
public class LikeBoxCountView extends FrameLayout {
    ...
    private void initialize(Context context) {
        ...
        caretHeight = getResources().getDimension(FacebookExtension.context.getResourceId("dimen.com_facebook_likeboxcountview_caret_height"));
        caretWidth = getResources().getDimension(FacebookExtension.context.getResourceId("dimen.com_facebook_likeboxcountview_caret_width"));
        borderRadius = getResources().getDimension(FacebookExtension.context.getResourceId("dimen.com_facebook_likeboxcountview_border_radius"));

        borderPaint = new Paint();
        borderPaint.setColor(
                getResources().getColor(FacebookExtension.context.getResourceId("color.com_facebook_likeboxcountview_border_color")));
        borderPaint.setStrokeWidth(getResources().getDimension(FacebookExtension.context.getResourceId("dimen.com_facebook_likeboxcountview_border_width")));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        likeCountLabel.setTextSize(
                ...
                getResources().getDimension(FacebookExtension.context.getResourceId("dimen.com_facebook_likeboxcountview_text_size")));
        likeCountLabel.setTextColor(
                getResources().getColor(FacebookExtension.context.getResourceId("color.com_facebook_likeboxcountview_text_color")));
        textPadding = getResources().getDimensionPixelSize(FacebookExtension.context.getResourceId("dimen.com_facebook_likeboxcountview_text_padding"));

        // Calculate the additional text padding that will be applied in the direction of the caret.
        additionalTextPadding = getResources().getDimensionPixelSize(FacebookExtension.context.getResourceId("dimen.com_facebook_likeboxcountview_caret_height"));
    }
