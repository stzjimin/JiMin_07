...
public class LikeView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(
                attrs, new int[] {
                		FacebookExtension.context.getResourceId("attr.com_facebook_foreground_color"),
                		FacebookExtension.context.getResourceId("attr.com_facebook_object_id"),
                		FacebookExtension.context.getResourceId("attr.com_facebook_object_type"),
                		FacebookExtension.context.getResourceId("attr.com_facebook_style"),
                		FacebookExtension.context.getResourceId("attr.com_facebook_auxiliary_view_position"),
                		FacebookExtension.context.getResourceId("attr.com_facebook_horizontal_alignment"),
                });
        if (a == null) {
            return;
        }
        ...
        objectId = Utility.coerceValueIfNullOrEmpty(
                a.getString(FacebookExtension.context.getResourceId("styleable.com_facebook_like_view_com_facebook_object_id")), null);
        objectType = ObjectType.fromInt(
                a.getInt(FacebookExtension.context.getResourceId("styleable.com_facebook_like_view_com_facebook_object_type"),
                        ObjectType.DEFAULT.getValue()));
        likeViewStyle = Style.fromInt(
                a.getInt(FacebookExtension.context.getResourceId("styleable.com_facebook_like_view_com_facebook_style"),
        ...
        auxiliaryViewPosition = AuxiliaryViewPosition.fromInt(
                a.getInt(FacebookExtension.context.getResourceId("styleable.com_facebook_like_view_com_facebook_auxiliary_view_position"),
        ...
        horizontalAlignment = HorizontalAlignment.fromInt(
                a.getInt(FacebookExtension.context.getResourceId("styleable.com_facebook_like_view_com_facebook_horizontal_alignment"),
        ...
        foregroundColor = a.getColor(
        		FacebookExtension.context.getResourceId("styleable.com_facebook_like_view_com_facebook_foreground_color"), NO_FOREGROUND_COLOR);
    ...
    private void initialize(Context context) {
        edgePadding = getResources().getDimensionPixelSize(FacebookExtension.context.getResourceId("dimen.com_facebook_likeview_edge_padding"));
        internalPadding = getResources().getDimensionPixelSize(FacebookExtension.context.getResourceId("dimen.com_facebook_likeview_internal_padding"));
        if (foregroundColor == NO_FOREGROUND_COLOR) {
            foregroundColor = getResources().getColor(FacebookExtension.context.getResourceId("color.com_facebook_likeview_text_color"));
        }
    ...
    private void initializeSocialSentenceView(Context context) {
        ...
        socialSentenceView.setTextSize(
                ...
                getResources().getDimension(FacebookExtension.context.getResourceId("dimen.com_facebook_likeview_text_size")));
