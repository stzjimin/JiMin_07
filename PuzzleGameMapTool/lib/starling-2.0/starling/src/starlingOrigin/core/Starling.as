...
package starlingOrigin.core
{
    ...
    [Event(name="render", type="starlingOrigin.events.Event")]
    ...
    public class Starling extends EventDispatcher
    {
        ...
        private function initializeRoot():void
        {
            if (_root == null && _rootClass != null)
            {
                ...
                dispatchEventWith(starlingOrigin.events.Event.ROOT_CREATED, false, _root);
            }
        }
        ...
        public function render():void
        {
            ...
            makeCurrent();
            updateViewPort();
            dispatchEventWith(starlingOrigin.events.Event.RENDER);
        ...
        public function stopWithFatalError(message:String):void
        {
            ...
            dispatchEventWith(starlingOrigin.events.Event.FATAL_ERROR, false, message);
        }
        ...
        private function onKey(event:KeyboardEvent):void
        {
            ...
            var keyEvent:starlingOrigin.events.KeyboardEvent = new starlingOrigin.events.KeyboardEvent(
                                    ...
                                    verticalAlign:String="top", scale:Number=1):void
        {
            if (context == null)
            {
                ...
                addEventListener(starlingOrigin.events.Event.ROOT_CREATED, onRootCreated);
            }
            else
            {
            ...
            function onRootCreated():void
            {
                ...
                removeEventListener(starlingOrigin.events.Event.ROOT_CREATED, onRootCreated);
            }
        }
