...
package starlingOrigin.display
{
    ...
    import starlingOrigin.core.starling_internal;
    import starlingOrigin.errors.AbstractClassError;
    import starlingOrigin.errors.AbstractMethodError;
    import starlingOrigin.events.Event;
    import starlingOrigin.events.EventDispatcher;
    import starlingOrigin.events.TouchEvent;
    import starlingOrigin.filters.FragmentFilter;
    import starlingOrigin.rendering.BatchToken;
    import starlingOrigin.rendering.Painter;
    import starlingOrigin.utils.Align;
    import starlingOrigin.utils.MathUtil;
    import starlingOrigin.utils.MatrixUtil;

    use namespace starling_internal;

    /** Dispatched when an object is added to a parent. */
    [Event(name="added", type="starlingOrigin.events.Event")]
    
    /** Dispatched when an object is connected to the stage (directly or indirectly). */
    [Event(name="addedToStage", type="starlingOrigin.events.Event")]
    
    /** Dispatched when an object is removed from its parent. */
    [Event(name="removed", type="starlingOrigin.events.Event")]
    
    /** Dispatched when an object is removed from the stage and won't be rendered any longer. */ 
    [Event(name="removedFromStage", type="starlingOrigin.events.Event")]
    
    /** Dispatched once every frame on every object that is connected to the stage. */ 
    [Event(name="enterFrame", type="starlingOrigin.events.EnterFrameEvent")]
    
    /** Dispatched when an object is touched. Bubbles. */
    [Event(name="touch", type="starlingOrigin.events.TouchEvent")]
    
    /** Dispatched when a key on the keyboard is released. */
    [Event(name="keyUp", type="starlingOrigin.events.KeyboardEvent")]
    
    /** Dispatched when a key on the keyboard is pressed. */
    [Event(name="keyDown", type="starlingOrigin.events.KeyboardEvent")]
