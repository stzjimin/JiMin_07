...
package starlingOrigin.filters
{
    ...
    import starlingOrigin.rendering.FilterEffect;
    import starlingOrigin.rendering.IndexData;
    import starlingOrigin.rendering.Painter;
    import starlingOrigin.rendering.VertexData;
    import starlingOrigin.textures.Texture;
    import starlingOrigin.utils.Padding;
    import starlingOrigin.utils.Pool;
    import starlingOrigin.utils.RectangleUtil;

    /** Dispatched when the settings change in a way that requires a redraw. */
    [Event(name="change", type="starlingOrigin.events.Event")]
