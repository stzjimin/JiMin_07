...
package starlingOrigin.text
{
    ...
    public class TextFormat extends EventDispatcher
    {
        ...
        public function copyFrom(format:starlingOrigin.text.TextFormat):void
        {
            _font = format._font;
            _size = format._size;
        ...
        public function clone():starlingOrigin.text.TextFormat
        {
            var clone:starlingOrigin.text.TextFormat = new starlingOrigin.text.TextFormat();
            clone.copyFrom(this);
            return clone;
        }
