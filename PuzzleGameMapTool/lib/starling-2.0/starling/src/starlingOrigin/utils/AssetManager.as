...
package starlingOrigin.utils
{
    ...
    import starlingOrigin.text.BitmapFont;
    import starlingOrigin.text.TextField;
    import starlingOrigin.textures.AtfData;
    import starlingOrigin.textures.Texture;
    import starlingOrigin.textures.TextureAtlas;
    import starlingOrigin.textures.TextureOptions;

    /** Dispatched when all textures have been restored after a context loss. */
    [Event(name="texturesRestored", type="starlingOrigin.events.Event")]
    ...
    [Event(name="ioError", type="starlingOrigin.events.Event")]

    /** Dispatched when an URLLoader fails with a SECURITY_ERROR while processing the queue.
     *  The 'data' property of the Event contains the URL-String that could not be loaded. */
    [Event(name="securityError", type="starlingOrigin.events.Event")]
    ...
    [Event(name="parseError", type="starlingOrigin.events.Event")]
