package
{
	...
	public class MapToolSpriteLoader
	{
		...
		public function MapToolSpriteLoader(completeFunc:Function, failFunc:Function)
		{
		...
		{
			trace(LoaderInfo(event.currentTarget).url);
			...
			_failFunc(LoaderInfo(event.currentTarget).loader.name + " File unLoaded");
		}
