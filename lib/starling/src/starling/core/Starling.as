...
package starling.core
{
    ...
    public class Starling extends EventDispatcher
    {
        ...
        private var _sceneManagerClass:Class;
         ...
         *                    </ul>
         */
        public function Starling(sceneManagerClass:Class, stage:flash.display.Stage, 
                                 ...
                                 renderMode:String="auto", profile:Object="auto")
        {
            ...
            _sceneManagerClass = sceneManagerClass; 
            _viewPort = viewPort;
        ...
        private function initializeRoot():void
        {
            if (_sceneManager == null && _sceneManagerClass != null)
            {
                ...
                dispatchEventWith(starling.events.Event.ROOT_CREATED, false, _sceneManager);
            }
        }
        ...
        public function get root():SceneManager { return _sceneManager; }
         ...
         *  instantiated.</p>
         */
        public function get rootClass():Class { return _sceneManagerClass; }
        public function set rootClass(value:Class):void
        {
            if (_sceneManagerClass != null && _sceneManager != null)
                throw new Error("Root class may not change after root has been instantiated");
            else if (_sceneManagerClass == null)
            {
                _sceneManagerClass = value;
